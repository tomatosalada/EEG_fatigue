...
if __name__ == '__main__':
    data = np.load("/content/drive/MyDrive/ColabNotebooks/SEED-VIGfile/Toshi-net/processedData/data_3d.npy")
    ...
    # [325680, 6, 9, 5] -> [20355, 16, 6, 9, 5]　　　　325680÷16=20355　(サンプル数, チャンク数（時間的特徴）, 高さ, 幅, 特徴数)
