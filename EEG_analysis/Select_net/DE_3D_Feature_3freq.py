...
if __name__ == '__main__':
    data = np.load("/content/drive/MyDrive/ColabNotebooks/SEED-VIGfile/Toshi_net/processedData/data_3d_3freq.npy")
    ...
    np.save('./processedData/data_3d_3freq_flat.npy', data_3d_reshape)