...
def decompose_to_DE(file):
    ...
    bands = 3
    # init DE [141600, 17, 3]　DE特徴量配列の初期化
    ...
    temp_trial_de = temp_de.reshape(-1, 3, num_sample)
...
if __name__ == '__main__':
    ...
    # save .npy file
    np.save("/workspace-cloud/toshiki.ohno/EEG_fatigue/EEG_analysis/processedData/data_3d_3freq.npy", X)